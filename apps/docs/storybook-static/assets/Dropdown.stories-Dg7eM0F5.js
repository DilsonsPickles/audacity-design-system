import{l as d,R as e,r as C}from"./iframe-cFmfFvS6.js";import"./preload-helper-C1FmrZbK.js";const R={title:"Components/Dropdown",component:d,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{disabled:{control:"boolean"},width:{control:"text"}}},a=[{value:"en",label:"System (English)"},{value:"es",label:"Español"},{value:"fr",label:"Français"},{value:"de",label:"Deutsch"},{value:"it",label:"Italiano"},{value:"ja",label:"日本語"},{value:"zh",label:"中文"}];function l(n){const[V,W]=C.useState(n.value||"");return e.createElement(d,{...n,value:V,onChange:u=>{var c;W(u),(c=n.onChange)==null||c.call(n,u)}})}const t={render:n=>e.createElement(l,{...n}),args:{options:a,placeholder:"Select language",width:"290px"}},o={render:n=>e.createElement(l,{...n}),args:{options:a,value:"en",width:"290px"}},r={render:n=>e.createElement(l,{...n}),args:{options:a,value:"en",disabled:!0,width:"290px"}},i={render:n=>e.createElement(l,{...n}),args:{options:a,placeholder:"Select",width:"162px"}},p={render:n=>e.createElement(l,{...n}),args:{options:[{value:"1",label:"Option 1"},{value:"2",label:"Option 2"},{value:"3",label:"Option 3"},{value:"4",label:"Option 4"},{value:"5",label:"Option 5"},{value:"6",label:"Option 6"},{value:"7",label:"Option 7"},{value:"8",label:"Option 8"},{value:"9",label:"Option 9"},{value:"10",label:"Option 10"},{value:"11",label:"Option 11"},{value:"12",label:"Option 12"},{value:"13",label:"Option 13"},{value:"14",label:"Option 14"},{value:"15",label:"Option 15"}],placeholder:"Select option",width:"200px"}},s={render:()=>e.createElement("div",{style:{display:"flex",flexDirection:"column",gap:"24px"}},e.createElement("div",null,e.createElement("div",{style:{marginBottom:"8px",fontSize:"12px",fontFamily:"Inter"}},"Idle"),e.createElement(d,{options:a,placeholder:"Select option",width:"200px"})),e.createElement("div",null,e.createElement("div",{style:{marginBottom:"8px",fontSize:"12px",fontFamily:"Inter"}},"With Value"),e.createElement(l,{options:a,value:"en",width:"200px"})),e.createElement("div",null,e.createElement("div",{style:{marginBottom:"8px",fontSize:"12px",fontFamily:"Inter"}},"Disabled"),e.createElement(d,{options:a,value:"en",disabled:!0,width:"200px"})))};var m,v,g;t.parameters={...t.parameters,docs:{...(m=t.parameters)==null?void 0:m.docs,source:{originalSource:`{
...
}`,...(g=(v=t.parameters)==null?void 0:v.docs)==null?void 0:g.source}}};var b,O,x;o.parameters={...o.parameters,docs:{...(b=o.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: args => <DropdownDemo {...args} />,
  args: {
    options: languageOptions,
    value: 'en',
...
}`,...(L=(B=s.parameters)==null?void 0:B.docs)==null?void 0:L.source}}};const _=["Default","WithValue","Disabled","Narrow","LongList","AllStates"];export{s as AllStates,t as Default,r as Disabled,p as LongList,i as Narrow,o as WithValue,_ as __namedExportsOrder,R as default};
