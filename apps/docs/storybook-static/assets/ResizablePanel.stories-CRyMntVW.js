import{r,R as e}from"./index-yIsmwZOr.js";import{R as o,v as F}from"./index-DR-q5OqV.js";import"./jsx-runtime-BjG_zV1W.js";import"./index-CZ_84MJS.js";import"./index-C1nsXWtN.js";const M={title:"Layout & Behavior/ResizablePanel",component:o,parameters:{layout:"padded"},tags:["autodocs"],argTypes:{minHeight:{control:{type:"number",min:20,max:200,step:1},description:"Minimum height the panel can be resized to"},maxHeight:{control:{type:"number",min:100,max:500,step:10},description:"Maximum height the panel can be resized to"},resizeEdge:{control:"select",options:["top","bottom","both"],description:"Which edge(s) can be used to resize"},resizeThreshold:{control:{type:"number",min:4,max:16,step:2},description:"Size of the resize zone in pixels"}}},a={render:()=>{const[t,i]=r.useState(114);return e.createElement("div",{style:{width:"300px"}},e.createElement(o,{initialHeight:t,minHeight:44,resizeEdge:"bottom",onHeightChange:i},e.createElement("div",{style:{backgroundColor:"#EEEEF1",padding:"12px",height:"100%",border:"1px solid #CDCED7",borderRadius:"4px"}},e.createElement("div",{style:{marginBottom:"8px",fontSize:"14px",fontWeight:600}},"Resizable Content"),e.createElement("div",{style:{fontSize:"12px",color:"#666"}},"Height: ",t,"px"),e.createElement("div",{style:{fontSize:"11px",color:"#999",marginTop:"8px"}},"Drag the bottom edge to resize"))))}},s={render:()=>{const[t,i]=r.useState(114),n=()=>t<44?"collapsed":t<80?"truncated":"default";return e.createElement("div",{style:{width:"240px",backgroundColor:"#f5f5f5",padding:"16px"}},e.createElement(o,{initialHeight:t,minHeight:44,resizeEdge:"bottom",onHeightChange:i},e.createElement(F,{trackName:"Audio Track",height:n(),state:"idle"})),e.createElement("div",{style:{marginTop:"16px",fontSize:"12px",color:"#666"}},"Current height: ",t,"px (",n(),")"))}},d={render:()=>{const[t,i]=r.useState(100);return e.createElement("div",{style:{width:"300px"}},e.createElement(o,{initialHeight:t,minHeight:60,maxHeight:200,resizeEdge:"bottom",onHeightChange:i},e.createElement("div",{style:{backgroundColor:"#EEEEF1",padding:"12px",height:"100%",border:"1px solid #CDCED7",borderRadius:"4px"}},e.createElement("div",{style:{marginBottom:"8px",fontSize:"14px",fontWeight:600}},"Constrained Resize"),e.createElement("div",{style:{fontSize:"12px",color:"#666"}},"Height: ",t,"px"),e.createElement("div",{style:{fontSize:"11px",color:"#999",marginTop:"8px"}},"Min: 60px, Max: 200px"))))}},l={args:{minHeight:60,resizeEdge:"bottom",resizeThreshold:8},render:t=>{const[i,n]=r.useState(100);return e.createElement("div",{style:{width:"300px"}},e.createElement(o,{...t,initialHeight:i,onHeightChange:n},e.createElement("div",{style:{backgroundColor:"#E3F2FD",padding:"12px",height:"100%",border:"1px solid #90CAF9",borderRadius:"4px"}},e.createElement("div",{style:{marginBottom:"8px",fontSize:"14px",fontWeight:600}},"Bottom Edge Resize"),e.createElement("div",{style:{fontSize:"12px",color:"#1976D2"}},"Drag bottom edge (",t.resizeThreshold,"px zone)"))))}},g={render:()=>{const[t,i]=r.useState(80),[n,P]=r.useState(120),[h,D]=r.useState(100);return e.createElement("div",{style:{width:"300px",display:"flex",flexDirection:"column",gap:"4px"}},e.createElement(o,{initialHeight:t,minHeight:44,resizeEdge:"bottom",onHeightChange:i,isFirstPanel:!0},e.createElement("div",{style:{backgroundColor:"#E3F2FD",padding:"12px",height:"100%",border:"1px solid #90CAF9"}},e.createElement("div",{style:{fontSize:"14px",fontWeight:600}},"Panel 1"),e.createElement("div",{style:{fontSize:"12px",color:"#1976D2"}},"Height: ",t,"px"))),e.createElement(o,{initialHeight:n,minHeight:44,resizeEdge:"bottom",onHeightChange:P},e.createElement("div",{style:{backgroundColor:"#F3E5F5",padding:"12px",height:"100%",border:"1px solid #CE93D8"}},e.createElement("div",{style:{fontSize:"14px",fontWeight:600}},"Panel 2"),e.createElement("div",{style:{fontSize:"12px",color:"#7B1FA2"}},"Height: ",n,"px"))),e.createElement(o,{initialHeight:h,minHeight:44,resizeEdge:"bottom",onHeightChange:D},e.createElement("div",{style:{backgroundColor:"#E8F5E9",padding:"12px",height:"100%",border:"1px solid #A5D6A7"}},e.createElement("div",{style:{fontSize:"14px",fontWeight:600}},"Panel 3"),e.createElement("div",{style:{fontSize:"12px",color:"#388E3C"}},"Height: ",h,"px"))))}};var p,c,m;a.parameters={...a.parameters,docs:{...(p=a.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: () => {
...
}`,...(R=(S=g.parameters)==null?void 0:S.docs)==null?void 0:R.source}}};const w=["Default","WithTrackControlPanel","MinMaxConstraints","BottomEdge","MultipleResizablePanels"];export{l as BottomEdge,a as Default,d as MinMaxConstraints,g as MultipleResizablePanels,s as WithTrackControlPanel,w as __namedExportsOrder,M as default};
