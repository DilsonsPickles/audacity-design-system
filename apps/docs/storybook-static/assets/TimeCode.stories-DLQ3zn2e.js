import{a2 as r,r as f,R as e}from"./iframe-cFmfFvS6.js";import"./preload-helper-C1FmrZbK.js";const _={title:"Components/TimeCode",component:r,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{value:{control:{type:"number",min:0,max:3600,step:.1},description:"Current time value in seconds"},format:{control:"select",options:["dd:hh:mm:ss","hh:mm:ss","hh:mm:ss+hundredths","hh:mm:ss+milliseconds","hh:mm:ss+samples","hh:mm:ss+frames","samples","seconds","seconds+milliseconds","film-frames","beats:bars","Hz"],description:"Format to display the timecode"},sampleRate:{control:{type:"number",min:8e3,max:192e3,step:100},description:"Sample rate for sample-based formats"},frameRate:{control:{type:"number",min:23.976,max:60,step:.001},description:"Frame rate for frame-based formats"},showFormatSelector:{control:"boolean",description:"Show format selector dropdown"},disabled:{control:"boolean",description:"Disabled state"}}},l={args:{value:125.5,format:"hh:mm:ss",sampleRate:44100,frameRate:24,showFormatSelector:!0,disabled:!1}},o={render:()=>{const[s]=f.useState(125.5),t=[{format:"dd:hh:mm:ss",label:"Days, Hours, Minutes, Seconds"},{format:"hh:mm:ss",label:"Hours, Minutes, Seconds"},{format:"hh:mm:ss+hundredths",label:"HH:MM:SS + Hundredths"},{format:"hh:mm:ss+milliseconds",label:"HH:MM:SS + Milliseconds"},{format:"hh:mm:ss+samples",label:"HH:MM:SS + Samples"},{format:"hh:mm:ss+frames",label:"HH:MM:SS + Frames"},{format:"samples",label:"Samples"},{format:"seconds",label:"Seconds"},{format:"seconds+milliseconds",label:"Seconds + Milliseconds"},{format:"film-frames",label:"Film Frames (24fps)"},{format:"beats:bars",label:"Beats:Bars"},{format:"Hz",label:"Hz"}];return e.createElement("div",{style:{display:"flex",flexDirection:"column",gap:"16px",padding:"20px"}},t.map(({format:a,label:p})=>e.createElement("div",{key:a,style:{display:"flex",alignItems:"center",gap:"16px"}},e.createElement("div",{style:{width:"250px",fontSize:"14px",color:"#666"}},p),e.createElement(r,{value:s,format:a,showFormatSelector:!1}))))}},n={render:()=>{const[s,t]=f.useState(125.5),[a,p]=f.useState("hh:mm:ss");return e.createElement("div",{style:{display:"flex",flexDirection:"column",gap:"24px",padding:"20px"}},e.createElement("div",{style:{display:"flex",flexDirection:"column",gap:"8px"}},e.createElement("label",{style:{fontSize:"14px",fontWeight:600}},"Time Value (seconds):"),e.createElement("input",{type:"range",min:"0",max:"3600",step:"0.1",value:s,onChange:W=>t(parseFloat(W.target.value)),style:{width:"300px"}}),e.createElement("span",{style:{fontSize:"12px",color:"#666"}},s.toFixed(1),"s")),e.createElement("div",{style:{display:"flex",flexDirection:"column",gap:"8px"}},e.createElement("label",{style:{fontSize:"14px",fontWeight:600}},"TimeCode Component:"),e.createElement(r,{value:s,format:a,onChange:t,onFormatChange:p,showFormatSelector:!0})))}},m={render:()=>{const t=[8e3,22050,44100,48e3,96e3,192e3];return e.createElement("div",{style:{display:"flex",flexDirection:"column",gap:"16px",padding:"20px"}},t.map(a=>e.createElement("div",{key:a,style:{display:"flex",alignItems:"center",gap:"16px"}},e.createElement("div",{style:{width:"100px",fontSize:"14px",color:"#666"}},a," Hz"),e.createElement(r,{value:1.5,format:"samples",sampleRate:a,showFormatSelector:!1}))))}},i={render:()=>{const t=[23.976,24,25,29.97,30,50,60];return e.createElement("div",{style:{display:"flex",flexDirection:"column",gap:"16px",padding:"20px"}},t.map(a=>e.createElement("div",{key:a,style:{display:"flex",alignItems:"center",gap:"16px"}},e.createElement("div",{style:{width:"80px",fontSize:"14px",color:"#666"}},a," fps"),e.createElement(r,{value:10.5,format:"film-frames",frameRate:a,showFormatSelector:!1}))))}},d={args:{value:125.5,format:"hh:mm:ss",disabled:!0,showFormatSelector:!0}},c={args:{value:125.5,format:"hh:mm:ss",showFormatSelector:!1}};var u,h,x;l.parameters={...l.parameters,docs:{...(u=l.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
    value: 125.5,
    format: 'hh:mm:ss',
    sampleRate: 44100,
...
}`,...(E=(D=i.parameters)==null?void 0:D.docs)==null?void 0:E.source}}};var C,z,T;d.parameters={...d.parameters,docs:{...(C=d.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    value: 125.5,
    format: 'hh:mm:ss',
    disabled: true,
...
}`,...(T=(z=d.parameters)==null?void 0:z.docs)==null?void 0:T.source}}};var I,k,V;c.parameters={...c.parameters,docs:{...(I=c.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    value: 125.5,
    format: 'hh:mm:ss',
    showFormatSelector: false
  }
}`,...(V=(k=c.parameters)==null?void 0:k.docs)==null?void 0:V.source}}};const O=["Default","AllFormats","Interactive","DifferentSampleRates","DifferentFrameRates","Disabled","WithoutFormatSelector"];export{o as AllFormats,l as Default,i as DifferentFrameRates,m as DifferentSampleRates,d as Disabled,n as Interactive,c as WithoutFormatSelector,O as __namedExportsOrder,_ as default};
