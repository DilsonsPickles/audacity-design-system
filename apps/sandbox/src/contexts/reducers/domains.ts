...
export const ACTION_DOMAIN: Record<TracksAction['type'], Domain> = {
  ...
  MOVE_TRACK: 'tracks', GROUP_SELECTED_TRACKS: 'tracks', UNGROUP_FOLDER: 'tracks', ADD_TRACK_TO_FOLDER: 'tracks', REMOVE_TRACK_FROM_FOLDER: 'tracks', TOGGLE_FOLDER_COLLAPSED: 'tracks', UPDATE_TRACK_HEIGHT: 'tracks', UPDATE_CHANNEL_SPLIT_RATIO: 'tracks',
