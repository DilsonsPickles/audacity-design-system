...
export const darkTheme: ThemeTokens = {
  ...
  audio: {
    waveform: {
      default: 'rgba(255, 255, 255, 0.7)', // Light waveform (70% opacity rendered)
      muted: 'rgba(255, 255, 255, 0.4)',   // Muted waveform (40% opacity rendered)
      rms: 'rgba(255, 255, 255, 0.5)',     // RMS waveform (50% opacity rendered)
